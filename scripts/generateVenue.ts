...
function generateVenue(): Venue {
  ...
  sections.push({
    ...
    rows: generateSeats('VIP', 1, 10, 50, 400, 50, 1),
  });
  ...
  sections.push({
    ...
    label: 'Lower Bowl A',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('LB-A', 1, 25, 40, 50, 250, 2),
  });
  ...
  sections.push({
    ...
    label: 'Lower Bowl B',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('LB-B', 1, 25, 40, 700, 250, 2),
  });
  ...
  sections.push({
    ...
    label: 'Lower Bowl C',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('LB-C', 1, 20, 35, 50, 750, 3),
  });
  ...
  sections.push({
    ...
    label: 'Lower Bowl D',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('LB-D', 1, 20, 35, 700, 750, 3),
  });
  ...
  sections.push({
    ...
    label: 'Upper Bowl A',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('UB-A', 1, 30, 45, 50, 1200, 4),
  });
  ...
  sections.push({
    ...
    label: 'Upper Bowl B',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('UB-B', 1, 30, 45, 700, 1200, 4),
  });
  ...
  sections.push({
    ...
    label: 'Upper Bowl C',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('UB-C', 1, 25, 40, 50, 1800, 4),
  });
  ...
  sections.push({
    ...
    label: 'Upper Bowl D',
    transform: { x: 0, y: 0, scale: 1 },
    rows: generateSeats('UB-D', 1, 25, 40, 700, 1800, 4),
  });

  const venue: Venue = {
    venueId: 'arena-01',
    name: 'Metropolis Arena',
    map: { width: 1400, height: 2400 },
    sections,
  };
